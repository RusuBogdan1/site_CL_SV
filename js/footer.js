      ...
      <footer class="site-footer">
        <div class="container">
          <div class="footer-top">
            <div class="footer-brand">
              ...
              <div class="footer-links-col">
                <li><a href="https://scout.ro/blog/2009/03/06/au-dat-calculatorul-i-televizorul-pe-munc/">⚜️ ONCR</a></li>
              </div>
            </div>
            ...
            <div class="footer-links-col">
              ...
              <ul class="footer-links">
                ...
                <li><a href="ce-eecte.html">Festivalul Luminii</a></li>
            ...
            <div class="footer-links-col">
              ...
              <ul class="footer-links">
                <li><a href="safe-from-harm.html">Politica Safe from Harm</a></li>
                <li><a href="donatii.html">Donații & Sponsorizări</a></li>
                <li><a href="https://formular230.ro/centrul-local-tinutul-fagilor-suceava-filiala-organizatiei-nationale-cercetasii-romani">Redirecționează 3.5%</a></li>
                <li><a href="ce-este-cercetasia.html#parinti">Ghid pentru Părinți</a></li>
                <li><a href="ce-esteste-cercetasia.html">Ce este Cercetășia?</a></li>
            ...
            <div class="footer-links-col">
              ...
              <ul class="footer-links">
                <li><a href="activitati.html">Activități de Centru & Campuri</a></li>
                <li><a href="activitati.html#evenimente">Evenimente</a></li>
                <li><a href="proi-cercetasia.html#adulti">Devino Voluntar Adult</a></li>
          ...
          <div class="footer-bottom">
            <p class="copyright">
              <span>${new Date().getFullYear()}</span> Centrul Local „Ținutul Fagilor” Suceava • Organizația Națională „Cercetașii României”. Toate drepturile rezervate.
            </p>
            <div class="footer-bottom-links">
              <a href="https://sfh.scout.ro/">Safe from Harm</a>
            </div>
          </div>
        </div>
      </footer>
